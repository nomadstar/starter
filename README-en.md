...
10. **Memory and Isolation:** The Architect has an automatically injected "short-term memory" that reminds it which files have already been built and approved, preventing repetition and context loss.
